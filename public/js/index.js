...
function stopRecording(thisButton, otherButton1, otherButton2) {
  ...
  thisButton.disabled = true;
  otherButton1.disabled = false;
  otherButton2.disabled = false;

}

function showDialog(thisButton, otherButton1, otherButton2){
  var x = document.getElementById("loading");
  x.style.display = "block"
  thisButton.disabled = true;
  otherButton1.disabled = true;
  otherButton2.disabled = true;
...
async function showRes(){
  ...
  document.getElementById("TransText").innerHTML = res.records[2].fields.transText
  document.getElementById("TransText").style.display = "block"
}


async function getTrans(){
  let response = await fetch('https://api.airtable.com/v0/appbBlzbiABwmEpy3/video?maxRecords=3&view=video', {
    headers: {
      'Authorization': 'Bearer keynT3YLOk5o96y76'
    }
  });
...
// async function getTrans(){
//     let response = fetch('https://api.airtable.com/v0/appbBlzbiABwmEpy3/video?maxRecords=3&view=video', {
//         headers: {
//             'Authorization': 'Bearer keycxjZQ8F2nzh3Uu'
//         }
//     });
//
//     return (await response).json()
